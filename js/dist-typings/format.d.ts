export declare function trans(key: string, parameters?: Record<string, unknown>): string | any[];
/**
 ...
 */
export declare function languageLabel(locale: string, name: string | null): string | any[];
/**
